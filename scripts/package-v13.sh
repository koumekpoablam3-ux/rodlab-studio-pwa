#!/bin/bash
# Package RodLab Studio PWA — v8.3.0 → rodlab-studio-pwa-v13.zip
set -euo pipefail

PROJ=/home/z/my-project
OLD_ZIP=$PROJ/download/rodlab-studio-pwa-v12.zip
NEW_ZIP=$PROJ/download/rodlab-studio-pwa-v13.zip
STAGE=$PROJ/.zstaging-v13
