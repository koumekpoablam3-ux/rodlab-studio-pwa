...
export const TIMELINE = [
  { year: "2018", title: "Les débuts", desc: "Rodrigue quitte son poste de développeur et lance RodLab Studio depuis une chambre à Tokoin, avec un ordinateur et beaucoup de détermination." },
...
export const TEAM = [
  { name: "K.A.S. Rodrigue", role: "Fondateur · et directeur de Rodlab", initials: "KR", color: "#bd4f2b", photo: `${IMG}/team-rodrigue.jpg`, bio: "KOUMEKPO Ablam Sotoh Rodrigue, développeur full-stack, plus particulièrement orienté frontend — il conçoit et construit chaque interface RodLab Studio." },
  ...
  { name: "NK. lightlove", role: "Communication & formation", initials: "AK", color: "#7a4a1f", photo: `${IMG}/team-kekeli.jpg`, bio: "Anime nos réseaux, forme nos apprenants et traduit le technique en langage clair. Une pièce maîtresse de l'équipe RodLab." },
];
