...
import { COURSE_HTML_CSS } from "./catalog-html-css";
import { COURSE_JAVASCRIPT } from "./catalog-javascript";
import { COURSE_PYTHON } from "./catalog-python";
import { COURSE_CPP } from "./catalog-cpp";
import { COURSE_MOBILE } from "./catalog-mobile";
import { CATALOG_QUIZZES_PROGRAMMATION } from "./catalog-quizzes-programmation";
...
/** CATALOGUE COMPLET v8.7 : le cours vedette + 5 formations + 5 cours de programmation avancée. */
