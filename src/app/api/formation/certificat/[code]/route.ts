...
async function buildCertificatePdf(data: {
  ...
  center("Lomé — Togo · www.rodlabstudio.tg", regular, 9, height - m2 - 33, rgb(0.85, 0.9, 0.85));
  ...
  center("Authenticité vérifiable en ligne : rodlabstudio.tg/certificats/" + data.code, italic, 9, 102, INK);
