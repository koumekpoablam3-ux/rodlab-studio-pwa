    ...
    <div className="mx-auto max-w-4xl">
      ...
      <div className="mt-6 overflow-hidden rounded-3xl border-2 border-forest-700 bg-cream-50">
        <div className="bg-forest-900 px-6 py-5 text-center sm:px-10">
          ...
          <p className="mt-1 text-[11px] text-forest-100/60">Lomé — Togo · www.rodlabstudio.tg</p>
        </div>
      ...
      <p className="mt-4 text-xs leading-relaxed text-ink-400">
        ...
        simplement le lien de la page de vérification : rodlabstudio.tg/certificats/{cert.code}.
      </p>
    </div>
  );
}
