...
import { FileText, Eye, Check, X, Loader2, Download } from "lucide-react";
          ...
          {quotes.map((q) => (
            <div key={q.id} className="flex flex-col rounded-3xl border border-cream-300 bg-card p-5 shadow-card">
              ...
              <div className="mt-4 flex items-center gap-2">
                ...
                <a href={`/api/quotes/${q.id}/pdf`} className="inline-flex items-center gap-1.5 rounded-full border border-cream-300 px-4 py-2 text-xs font-semibold text-ink-700 transition hover:bg-cream-100" aria-label={`Télécharger le devis ${q.number} en PDF`}>
