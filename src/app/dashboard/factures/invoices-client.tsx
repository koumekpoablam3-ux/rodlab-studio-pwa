          ...
          {viewing && (
            <>
              ...
              <div className="no-print flex justify-end gap-2 border-t border-cream-200 pt-4">
                <button onClick={() => window.print()} className="inline-flex items-center gap-2 rounded-full bg-forest-700 px-5 py-2.5 text-sm font-semibold text-cream-50 transition hover:bg-forest-800">
