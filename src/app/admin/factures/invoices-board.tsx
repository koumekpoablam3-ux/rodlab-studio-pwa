...
import { Plus, Loader2, Trash2, Receipt, Search, CheckCircle2, Download } from "lucide-react";
                    ...
                    <td className="px-5 py-4">
                      ...
                      {inv.status === "OVERDUE" && (
                        <p className="mt-1 text-[10px] text-ink-400">
                          {inv.reminderSentAt ? `Rappel envoyé le ${formatDate(inv.reminderSentAt)}` : "Rappel automatique ce soir"}
                        </p>
                      )}
                    </td>
